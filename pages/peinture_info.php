...
?>
    ...
    ?>
            <meta name="description" content="Peinture de Frédéric LEJEUNE - BLABLAL" />
...
////////////////////////MODIFIER + SUPPRIMER :
                if(isset($_SESSION['id']) && isset($_SESSION['user'])) // SI JE SUIS CONNECTE
                    ...
                    ';
                        echo'
                                <img class="img-responsive" src="http://ars-teatime.com/img/peinture/frederic_lejeune/'.$data['img'].'" alt="Chania">
                            </div>
                            ...
                            echo'
                                <div class="pin">
                                    <a href="peinture_info.php?id='.$data['id'].'">
                                        <img src="http://ars-teatime.com/img/peinture/frederic_lejeune/'.$data['img'].'">
                                    </a>
                                        <h3 class="auteur">'.$data['auteur'].'</h3>
                                        <a class="titre">'.$data['titre'].'</a>
                                        <p class="dimension">'.$data['hauteur'].' x '.$data['largeur'].' x '.$data['epaisseur'].' cm</p>
                        ...
                        <span id="exitReserver"></span>
                            ...
                            <form action="../php/divers/mailer.php" method="POST" role="form" enctype="multipart/form-data">
                                ...
                                <div class="text-center">
                                    ...
                                    <input type="hidden" name="subject" value="achat de l\'oeuvre '.$oeuvre.' de '.$auteur.'">
                                </div>
                            </form>
                        </div>
                       <div id="opacity"></div>
